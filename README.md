...
- Gathered the all variables outcome of different launch sites,
boosters, payload, to determine the success rate of the first stage,
and thus determining the cost of a launch
- Tested different prediction methods and evaluated their accuracy
- Logistic Regression is the most accurate and can be used to predict
